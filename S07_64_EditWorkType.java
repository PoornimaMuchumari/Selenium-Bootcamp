...
public class S07_64_EditWorkType {
	...
	Expected Result:
		...
		driver.findElement(By.xpath("(//label[@class='label inputLabel uiLabel-left form-element__label uiLabel'])[8]/following-sibling::input")).sendKeys("18");
		...
		if(text.contains("was saved."))
			System.out.println("Work Type updated Successfully");
		else 
			System.out.println("Work Type is failed to update");
